...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Eternal AIChat`}</title>

        <meta
          name="description"
          content="Experience the future of communication with Eternal AIChat - your personal portal to interact with openAI API. Secure, personalized, and interactive, it's more than just a chat."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-8707de31f9c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0JTIwYXBwbGljYXRpb258ZW58MHx8fHwxNjkxOTE1Mzg0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of communication with Eternal AIChat - your personal portal to interact with openAI API. Secure, personalized, and interactive, it's more than just a chat.`}
            </Text>
            <Box
